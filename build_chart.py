...
<p class="sub">Wallingford, Seattle &middot; net new units from issued construction permits, 2016&ndash;2025 &middot; built {today}</p>
...
<ul>
 ...
 <li><b>Window</b> = the last 10 years (2016&ndash;2025). Units permitted before 2016 are carried as a starting baseline (Stone Way {base.get('Stone Way N', 0):.0f}, 45th {base.get('N/NE 45th St', 0):.0f}), so the cumulative lines still reflect all activity back to 2004 and the totals stay accurate.</li>
