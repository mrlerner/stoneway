...
<ul>
 ...
 <li><b>Window</b> = 2011&ndash;2025 (permitting before 2011 was sparse). Units permitted before 2011 are carried as a starting baseline (Stone Way {base.get('Stone Way N', 0):.0f}, 45th {base.get('N/NE 45th St', 0):.0f}), so the cumulative lines still reflect all activity back to 2004 and the totals stay accurate.</li>
